...
import { getTraversing, setTraversing } from '@twinlogix/tl-commons'
...
> implements DAO<ModelType, IDKey, IDAutogenerated, FilterType, SortType, UpdateType, ExcludedFields, OptionsType>
{
  ...
  public apiV1: DAOWrapperAPIv1<ModelType, IDKey, IDAutogenerated, FilterType, SortType, UpdateType, ExcludedFields, OptionsType>
  ...
  protected constructor({
    ...
    this.apiV1 = new DAOWrapperAPIv1<ModelType, IDKey, IDAutogenerated, FilterType, SortType, UpdateType, ExcludedFields, OptionsType>(this, idField)
  }
  ...
  async findAll<P extends AnyProjection<ModelType> = true>(params: FindParams<FilterType, P, SortType, OptionsType>): Promise<ModelProjection<ModelType, P>[]> {
  ...
  async findOne<P extends AnyProjection<ModelType> = true>(params: FindOneParams<FilterType, P, OptionsType>): Promise<ModelProjection<ModelType, P> | null> {
    const newParams = await this.beforeFind({ ...params })
