...
>(args: {
  ...
  requiredProjection: P
  compute: (record: ModelProjection<ModelType, P>) => Promise<PartialDeep<ModelType>>
}): DAOMiddleware<ModelType, IDKey, IDAutogenerated, FilterType, UpdateType, ExcludedFields, SortType> {
  return {
...
export interface DAO<ModelType, IDKey extends keyof Omit<ModelType, ExcludedFields>, IDAutogenerated extends boolean, FilterType, SortType, UpdateType, ExcludedFields extends keyof ModelType> {
  ...
  findPage<ProjectionType extends AnyProjection<ModelType> = true>(
    params: FindParams<FilterType, ProjectionType, SortType>,
...
export abstract class AbstractDAO<
  ...
  UpdateType,
  ExcludedFields extends keyof ModelType,
> implements DAO<ModelType, IDKey, IDAutogenerated, FilterType, SortType, UpdateType, ExcludedFields>
{
  ...
  protected constructor({
    ...
    associations = [],
    middlewares = [],
  }: { idField: IDKey; daoContext: AbstractDAOContext } & DAOParams<ModelType, IDKey, boolean, FilterType, any, ExcludedFields, SortType>) {
