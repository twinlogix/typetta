...
export function projectionDependency<ModelType, P extends StaticProjection<ModelType>, IDKey extends keyof Omit<ModelType, ExcludedFields>, IDAutogenerated extends boolean, FilterType, UpdateType, ExcludedFields extends keyof ModelType, SortType>(args: { fieldsProjection: Projection<ModelType>; requiredProjection: P }): DAOMiddleware<ModelType, IDKey, IDAutogenerated, FilterType, UpdateType, ExcludedFields, SortType> {
  return {
...
export function buildComputedField<ModelType, P extends StaticProjection<ModelType>, IDKey extends keyof Omit<ModelType, ExcludedFields>, IDAutogenerated extends boolean, FilterType, UpdateType, ExcludedFields extends keyof ModelType, SortType>(args: { fieldsProjection: Projection<ModelType>; requiredProjection: P; compute: (record: ModelProjection<ModelType, P>) => Promise<PartialDeep<ModelType>> }): DAOMiddleware<ModelType, IDKey, IDAutogenerated, FilterType, UpdateType, ExcludedFields, SortType> {
  return {
    beforeFind: projectionDependency<ModelType, P, IDKey, IDAutogenerated, FilterType, UpdateType, ExcludedFields, SortType>(args).beforeFind,
...
export type InsertParams<ModelType, IDKey extends keyof Omit<ModelType, ExcludedFields>, ExcludedFields extends keyof ModelType, IDAutogenerated extends boolean> = {
  record: ConditionalPartialBy<Omit<ModelType, ExcludedFields>, IDKey, IDAutogenerated>
  options?: WriteOptions
}

export type UpdateParams<FilterType, UpdateType> = {
  filter: FilterType
  changes: UpdateType
  options?: WriteOptions
}

export type ReplaceParams<FilterType, ModelType, ExcludedFields extends keyof ModelType> = {
  filter: FilterType
  replace: Omit<ModelType, ExcludedFields>
  options?: WriteOptions
}

export type DeleteParams<FilterType> = {
  filter: FilterType
  options?: WriteOptions
}

export interface DAO<ModelType, IDKey extends keyof Omit<ModelType, ExcludedFields>, IDAutogenerated extends boolean, FilterType, SortType, UpdateType, ExcludedFields extends keyof ModelType> {
  findMany<ProjectionType extends AnyProjection<ModelType> = true>(params: FindParams<FilterType, ProjectionType, SortType>): Promise<ModelProjection<ModelType, ProjectionType>[]>
  findFirst<ProjectionType extends AnyProjection<ModelType> = true>(params: FindOneParams<FilterType, ProjectionType>): Promise<ModelProjection<ModelType, ProjectionType> | null>
  ...
  insertOne(params: InsertParams<ModelType, IDKey, ExcludedFields, IDAutogenerated>): Promise<Omit<ModelType, ExcludedFields>>
  updateOne(params: UpdateParams<FilterType, UpdateType>): Promise<void>
  updateMany(params: UpdateParams<FilterType, UpdateType>): Promise<void>
  replaceOne(params: ReplaceParams<FilterType, ModelType, ExcludedFields>): Promise<void>
  deleteOne(params: DeleteParams<FilterType>): Promise<void>
  deleteMany(params: DeleteParams<FilterType>): Promise<void>

  find<P extends AnyProjection<ModelType> = true>(filter: FilterType, projection?: P, sorts?: SortType, start?: number, limit?: number, options?: ReadOptions): Promise<ModelProjection<ModelType, P>[]>
  findOne<P extends AnyProjection<ModelType> = true>(filter: FilterType, projection?: P, options?: ReadOptions): Promise<ModelProjection<ModelType, P> | null>
  insert(record: ConditionalPartialBy<Omit<ModelType, ExcludedFields>, IDKey, IDAutogenerated>, options?: WriteOptions): Promise<Omit<ModelType, ExcludedFields>>
  update<T extends Pick<ModelType, IDKey>>(record: T, changes: UpdateType, options?: WriteOptions): Promise<void>
  replace<T extends Pick<ModelType, IDKey>>(record: T, replace: Omit<ModelType, ExcludedFields>, options?: WriteOptions): Promise<void>
...
export type DAOMiddleware<ModelType, IDKey extends keyof Omit<ModelType, ExcludedFields>, IDAutogenerated extends boolean, FilterType, UpdateType, ExcludedFields extends keyof ModelType, SortType> = {
  beforeFind?: (params: FindParams<FilterType, Projection<ModelType>, SortType>) => Promise<FindParams<FilterType, Projection<ModelType>, SortType>>
  afterFind?: (params: FindParams<FilterType, Projection<ModelType>, SortType>, result: PartialDeep<ModelType> | null) => Promise<PartialDeep<ModelType>>
  beforeInsert?: (params: InsertParams<ModelType, IDKey, ExcludedFields, IDAutogenerated>) => Promise<InsertParams<ModelType, IDKey, ExcludedFields, IDAutogenerated>>
  afterInsert?: (params: InsertParams<ModelType, IDKey, ExcludedFields, IDAutogenerated>, result: Omit<ModelType, ExcludedFields>) => Promise<Omit<ModelType, ExcludedFields>>
  beforeUpdate?: (params: UpdateParams<FilterType, UpdateType>) => Promise<UpdateParams<FilterType, UpdateType>>
  afterUpdate?: (params: UpdateParams<FilterType, UpdateType>) => Promise<void>
  beforeReplace?: (params: ReplaceParams<FilterType, ModelType, ExcludedFields>) => Promise<ReplaceParams<FilterType, ModelType, ExcludedFields>>
  afterReplace?: (params: ReplaceParams<FilterType, ModelType, ExcludedFields>) => Promise<void>
  beforeDelete?: (params: DeleteParams<FilterType>) => Promise<DeleteParams<FilterType>>
  afterDelete?: (params: DeleteParams<FilterType>) => Promise<void>
}
...
export abstract class AbstractDAO<ModelType, IDKey extends keyof Omit<ModelType, ExcludedFields>, IDAutogenerated extends boolean, FilterType, SortType, UpdateType, ExcludedFields extends keyof ModelType> implements DAO<ModelType, IDKey, IDAutogenerated, FilterType, SortType, UpdateType, ExcludedFields> {
  ...
  protected async beforeFind(params: FindParams<FilterType, Projection<ModelType>, SortType>): Promise<FindParams<FilterType, Projection<ModelType>, SortType>> {
  ...
  protected async afterFind(params: FindParams<FilterType, Projection<ModelType>, SortType>, result: PartialDeep<ModelType>): Promise<PartialDeep<ModelType>> {
    for (const middleware of this.middlewares) {
  ...
  async find<P extends AnyProjection<ModelType> = true>(filter: FilterType, projection?: P, sorts?: SortType, start?: number, limit?: number, options?: ReadOptions): Promise<ModelProjection<ModelType, P>[]> {
    return this.findMany({ filter, projection, sorts, start, limit, options })
  }
  async findOne<P extends AnyProjection<ModelType> = true>(filter: FilterType, projection?: P, options?: ReadOptions): Promise<ModelProjection<ModelType, P> | null> {
    return this.findFirst({ filter, projection, options })
  }

  async findMany<P extends AnyProjection<ModelType> = true>(params: FindParams<FilterType, P, SortType>): Promise<ModelProjection<ModelType, P>[]> {
  ...
  async findFirst<P extends AnyProjection<ModelType> = true>(params: FindOneParams<FilterType, P>): Promise<ModelProjection<ModelType, P> | null> {
    const newParams = await this.beforeFind({ ...params })
  ...
  // ---------------------------- ASSOCIATIONS -----------------------------
  // -----------------------------------------------------------------------
  private async load(keys: IDKey[], buildFilter: (keys: IDKey[]) => FilterType, hasKey: (record: ModelType, key: IDKey) => boolean, projection: Projection<ModelType>, loaderIdetifier: string = ''): Promise<(ModelType | null | Error)[]> {
  ...
  private getDataLoader(buildFilter: (keys: any[]) => FilterType, hasKey: (record: ModelType, key: any) => boolean, projection: Projection<ModelType>, loaderIdetifier: string): DataLoader<any, ModelType[] | null> {
  ...
  private async beforeInsert(params: InsertParams<ModelType, IDKey, ExcludedFields, IDAutogenerated>): Promise<InsertParams<ModelType, IDKey, ExcludedFields, IDAutogenerated>> {
    for (const middleware of this.middlewares) {
  ...
  private async afterInsert(params: InsertParams<ModelType, IDKey, ExcludedFields, IDAutogenerated>, result: Omit<ModelType, ExcludedFields>): Promise<Omit<ModelType, ExcludedFields>> {
    for (const middleware of this.middlewares) {
  ...
  async insert(record: ConditionalPartialBy<Omit<ModelType, ExcludedFields>, IDKey, IDAutogenerated>, options?: WriteOptions): Promise<Omit<ModelType, ExcludedFields>> {
    return this.insertOne({ record, options })
  }

  async insertOne(params: InsertParams<ModelType, IDKey, ExcludedFields, IDAutogenerated>): Promise<Omit<ModelType, ExcludedFields>> {
  ...
  private async beforeUpdate(params: UpdateParams<FilterType, UpdateType>): Promise<UpdateParams<FilterType, UpdateType>> {
    for (const middleware of this.middlewares) {
  ...
  private async afterUpdate(params: UpdateParams<FilterType, UpdateType>) {
    for (const middleware of this.middlewares) {
  ...
  async updateOne(params: UpdateParams<FilterType, UpdateType>): Promise<void> {
    const newParams = await this.beforeUpdate(params)
    await this._updateOne(newParams)
    await this.afterUpdate(newParams)
  }

  async updateMany(params: UpdateParams<FilterType, UpdateType>): Promise<void> {
    const newParams = await this.beforeUpdate(params)
    await this._updateMany(newParams)
    await this.afterUpdate(newParams)
  }

  private async beforeReplace(params: ReplaceParams<FilterType, ModelType, ExcludedFields>): Promise<ReplaceParams<FilterType, ModelType, ExcludedFields>> {
    for (const middleware of this.middlewares) {
  ...
  private async afterReplace(params: ReplaceParams<FilterType, ModelType, ExcludedFields>): Promise<void> {
    for (const middleware of this.middlewares) {
  ...
  async replace<T extends Pick<ModelType, IDKey>>(record: T, replace: Omit<ModelType, ExcludedFields>, options?: WriteOptions): Promise<void> {
    return this.replaceOne({ filter: this.idFilter(record), replace, options })
  }

  async replaceOne(params: ReplaceParams<FilterType, ModelType, ExcludedFields>): Promise<void> {
    const newParams = await this.beforeReplace(params)
    await this._replaceOne(newParams)
    await this.afterReplace(newParams)
  }

  private async beforeDelete(params: DeleteParams<FilterType>): Promise<DeleteParams<FilterType>> {
    for (const middleware of this.middlewares) {
  ...
  private async afterDelete(params: DeleteParams<FilterType>): Promise<void> {
    for (const middleware of this.middlewares) {
  ...
  async deleteOne(params: DeleteParams<FilterType>): Promise<void> {
    const newParams = await this.beforeDelete(params)
    await this._deleteOne(newParams)
    await this.afterDelete(newParams)
  }

  async deleteMany(params: DeleteParams<FilterType>): Promise<void> {
    const newParams = await this.beforeDelete(params)
  ...
  protected abstract _insertOne(params: InsertParams<ModelType, IDKey, ExcludedFields, IDAutogenerated>): Promise<Omit<ModelType, ExcludedFields>>
  protected abstract _updateOne(params: UpdateParams<FilterType, UpdateType>): Promise<void>
  protected abstract _updateMany(params: UpdateParams<FilterType, UpdateType>): Promise<void>
  protected abstract _replaceOne(params: ReplaceParams<FilterType, ModelType, ExcludedFields>): Promise<void>
  protected abstract _deleteOne(params: DeleteParams<FilterType>): Promise<void>
  protected abstract _deleteMany(params: DeleteParams<FilterType>): Promise<void>
}
