...
import { DAOAssociationReference, ReadOptions, WriteOptions, AbstractDAO, DAOParams, FindParams, FindOneParams, FilterParams, InsertParams, UpdateParams, ReplaceParams, DeleteParams } from '../dao'
...
export abstract class AbstractMongooseDAO<ModelType, IDKey extends keyof Omit<ModelType, ExcludedFields>, IDAutogenerated extends boolean, FilterType, SortType, UpdateType, ExcludedFields extends keyof ModelType> extends AbstractDAO<Model<Document>, Document, ModelType, IDKey, IDAutogenerated, FilterType, SortType, UpdateType, ExcludedFields> {
  ...
  protected async _find(params: FindParams<FilterType, Projection<ModelType>, SortType>): Promise<PartialDeep<ModelType>[]> {
    if (params.limit === 0) {
      ...
      const dbOptions = { skip: params.start, limit: params.limit, sort: this.sortsToDB(params.sort), ...(params.options || {})._ }
