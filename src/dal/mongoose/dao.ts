...
> extends AbstractDAO<ModelType, IDKey, IDAutogenerated, FilterType, SortType, UpdateType, ExcludedFields> {
  ...
  protected constructor({
    dbModel,
    ...params
  }: { idField: IDKey; daoContext: AbstractDAOContext; dbModel: Model<Document> } & DAOParams<ModelType, IDKey, IDAutogenerated, FilterType, UpdateType, ExcludedFields, SortType>) {
    super(params)
