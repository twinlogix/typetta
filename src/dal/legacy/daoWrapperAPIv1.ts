...
export class DAOWrapperAPIv1<
  ...
  public apiV2: AbstractDAO<ModelType, IDKey, IDType, IDAutogenerated, FilterType, ProjectionType, SortType, UpdateType, ExcludedFields, OptionsType, DriverOptionType, ScalarsType>
  constructor(apiV2: AbstractDAO<ModelType, IDKey, IDType, IDAutogenerated, FilterType, ProjectionType, SortType, UpdateType, ExcludedFields, OptionsType, DriverOptionType, ScalarsType>, idField: IDKey) {
    this.apiV2 = apiV2
  ...
  async find<P extends AnyProjection<ModelType, ProjectionType> = true>(
    filter: FilterType,
    projection?: P,
  ...
  async findOne<P extends AnyProjection<ModelType, ProjectionType> = true>(filter: FilterType, projection?: P, options?: OptionsType & DriverOptionType): Promise<ModelProjection<ModelType, P> | null> {
  ...
  async insert(record: ConditionalPartialBy<Omit<ModelType, ExcludedFields>, IDKey, IDAutogenerated>, options?: OptionsType & DriverOptionType): Promise<Omit<ModelType, ExcludedFields>> {
