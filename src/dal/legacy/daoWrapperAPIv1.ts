...
> {
  ...
  public apiV2: AbstractDAO<ModelType, IDKey, IDType, IDAutogenerated, FilterType, ProjectionType, SortType, UpdateType, ExcludedFields, OptionsType, ScalarsType>
  constructor(apiV2: AbstractDAO<ModelType, IDKey, IDType, IDAutogenerated, FilterType, ProjectionType, SortType, UpdateType, ExcludedFields, OptionsType, ScalarsType>, idField: IDKey) {
    this.apiV2 = apiV2
  ...
  async findOne<P extends AnyProjection<ModelType, ProjectionType> = true>(filter: FilterType, projection?: P, options?: OptionsType): Promise<ModelProjection<ModelType, P> | null> {
