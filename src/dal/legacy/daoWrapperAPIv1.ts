...
> {
  ...
  constructor(
    apiV2: AbstractDAO<ModelType, IDKey, IDType, IDAutogenerated, FilterType, ProjectionType, SortType, UpdateType, ExcludedFields, OptionsType, DriverOptionType, ScalarsType>,
    idField: IDKey,
  ) {
    this.apiV2 = apiV2
  ...
  async findOne<P extends AnyProjection<ProjectionType>>(
    filter: FilterType,
    projection?: P,
    options?: OptionsType & DriverOptionType,
  ): Promise<ModelProjection<ModelType, ProjectionType, P> | null> {
