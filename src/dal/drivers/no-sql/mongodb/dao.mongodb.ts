...
export class AbstractMongoDBDAO<
  ...
  > extends AbstractDAO<ModelType, IDKey, IDType, IDAutogenerated, FilterType, ProjectionType, SortType, UpdateType, ExcludedFields, OptionsType, { collection: Collection }, ScalarsType> {
