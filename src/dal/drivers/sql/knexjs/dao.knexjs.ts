...
export class AbstractKnexJsDAO<
  ...
  > extends AbstractDAO<ModelType, IDKey, IDType, IDAutogenerated, FilterType, ProjectionType, SortType, UpdateType, ExcludedFields, OptionsType, { knex: Knex }, ScalarsType> {
  ...
  protected async _findPage<P extends AnyProjection<ProjectionType>>(
