...
> = {
  ...
  middlewares?: DAOMiddleware<ModelType, IDKey, IDAutogenerated, FilterType, AnyProjection<ProjectionType>, UpdateType, ExcludedFields, SortType, OptionsType & DriverOptionsType, ScalarsType>[]
}
