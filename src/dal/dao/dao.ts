  ...
  > implements DAO<ModelType, IDKey, IDAutogenerated, FilterType, ProjectionType, SortType, UpdateType, ExcludedFields, OptionsType>
{
  ...
  protected middlewares: DAOMiddleware<ModelType, IDKey, IDAutogenerated, FilterType, AnyProjection<ModelType, ProjectionType>, UpdateType, ExcludedFields, SortType, OptionsType & DriverOptionType, ScalarsType>[]
  ...
  protected async beforeFind(params: FindParams<FilterType, AnyProjection<ModelType, ProjectionType>, SortType, OptionsType>): Promise<FindParams<FilterType, AnyProjection<ModelType, ProjectionType>, SortType, OptionsType & DriverOptionType>> {
  ...
  async findAll<P extends AnyProjection<ModelType, ProjectionType> = true>(params: FindParams<FilterType, P, SortType, OptionsType> = {}): Promise<ModelProjection<ModelType, P>[]> {
    ...
    return (await this.elabRecords(newParams, resolvedRecors)) as ModelProjection<ModelType, P>[]
  }
  ...
  async findOne<P extends AnyProjection<ModelType, ProjectionType> = true>(params: FindOneParams<FilterType, P, OptionsType> = {}): Promise<ModelProjection<ModelType, P> | null> {
    ...
    if (record) {
      ...
      return ((await this.elabRecords(newParams, resolvedRecors)) as ModelProjection<ModelType, P>[])[0]
    }
    return null
  }

  async findPage<P extends AnyProjection<ModelType, ProjectionType> = true>(params: FindParams<FilterType, P, SortType, OptionsType> = {},): Promise<{ totalCount: number; records: ModelProjection<ModelType, P>[] }> {
    ...
    return {
      totalCount,
      records: ((await this.elabRecords(newParams, resolvedRecors)) as ModelProjection<ModelType, P>[]),
    }
  }
  ...
  private async beforeReplace(params: ReplaceParams<FilterType, ModelType, ExcludedFields, OptionsType>): Promise<ReplaceParams<FilterType, ModelType, ExcludedFields, OptionsType & DriverOptionType>> {
    const contextOptions = this.createContextOptions()
    let enrichedParams = this.addOptions(params, this.driverOptions, this.options);
    for (const middleware of this.middlewares) {
