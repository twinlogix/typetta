  ...
  > implements DAO<ModelType, IDKey, IDAutogenerated, FilterType, ProjectionType, SortType, UpdateType, ExcludedFields, OptionsType>
{
  ...
  protected async afterFind(params: FindParams<FilterType, AnyProjection<ProjectionType>, SortType, OptionsType & DriverOptionType>, records: PartialDeep<ModelType>[]): Promise<PartialDeep<ModelType>[]> {
    const contextOptions = this.createContextOptions()
