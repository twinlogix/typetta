...
> implements DAO<ModelType, IDKey, IDAutogenerated, FilterType, ProjectionType, SortType, UpdateType, ExcludedFields, OptionsType>
{
  ...
  protected async beforeFind(params: FindParams<FilterType, ProjectionType, SortType, OptionsType>): Promise<FindParams<FilterType, ProjectionType, SortType, OptionsType>> {
  ...
  protected async afterFind(params: FindParams<FilterType, ProjectionType, SortType, OptionsType>, result: PartialDeep<ModelType>): Promise<PartialDeep<ModelType>> {
    const contextOptions = this.createContextOptions()
  ...
  private async elabRecords<P extends AnyProjection<ModelType, ProjectionType>>(
    ...
    for (const record of records) {
      results.push(await this.afterFind(params as FindParams<FilterType, ProjectionType, SortType, OptionsType>, record))
    }
