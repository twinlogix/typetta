...
export function projectionDependency<
  ...
  SortType,
  OptionsType,
>(args: { fieldsProjection: ProjectionType; requiredProjection: P }): DAOMiddleware<ModelType, IDKey, IDAutogenerated, FilterType, ProjectionType, UpdateType, ExcludedFields, SortType, OptionsType> {
  return {
