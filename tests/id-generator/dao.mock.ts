...
type BDAOGenerics<MetadataType, OperationMetadataType> = T.MongoDBDAOGenerics<types.B, 'id', 'ID', BFilter, BRawFilter, BRelations, BProjection, BSort, BRawSort, BInsert, BUpdate, BRawUpdate, BExcludedFields, BRelationFields, MetadataType, OperationMetadataType, types.Scalars, 'b', EntityManager<MetadataType, OperationMetadataType>>
...
type CDAOGenerics<MetadataType, OperationMetadataType> = T.MongoDBDAOGenerics<types.C, 'id', 'ID', CFilter, CRawFilter, CRelations, CProjection, CSort, CRawSort, CInsert, CUpdate, CRawUpdate, CExcludedFields, CRelationFields, MetadataType, OperationMetadataType, types.Scalars, 'c', EntityManager<MetadataType, OperationMetadataType>>
...
type DDAOGenerics<MetadataType, OperationMetadataType> = T.KnexJsDAOGenerics<types.D, 'id', 'IntAutoInc', DFilter, DRawFilter, DRelations, DProjection, DSort, DRawSort, DInsert, DUpdate, DRawUpdate, DExcludedFields, DRelationFields, MetadataType, OperationMetadataType, types.Scalars, 'd', EntityManager<MetadataType, OperationMetadataType>>
...
type EDAOGenerics<MetadataType, OperationMetadataType> = T.KnexJsDAOGenerics<types.E, 'id', 'ID', EFilter, ERawFilter, ERelations, EProjection, ESort, ERawSort, EInsert, EUpdate, ERawUpdate, EExcludedFields, ERelationFields, MetadataType, OperationMetadataType, types.Scalars, 'e', EntityManager<MetadataType, OperationMetadataType>>
...
type FDAOGenerics<MetadataType, OperationMetadataType> = T.KnexJsDAOGenerics<types.F, 'id', 'ID', FFilter, FRawFilter, FRelations, FProjection, FSort, FRawSort, FInsert, FUpdate, FRawUpdate, FExcludedFields, FRelationFields, MetadataType, OperationMetadataType, types.Scalars, 'f', EntityManager<MetadataType, OperationMetadataType>>
...
export class EntityManager<MetadataType = never, OperationMetadataType = never, Permissions extends string = never, SecurityDomain extends object = never> extends T.AbstractEntityManager<'a' | 'default', 'default', types.Scalars, MetadataType>  {
  ...
  get a(): ADAO<MetadataType, OperationMetadataType> {
    if(!this._a) {
      ...
      this._a = db === 'mock' ? (new InMemoryADAO({ entityManager: this, datasource: null, metadata: this.metadata, ...this.overrides?.a, middlewares: [...(this.overrides?.a?.middlewares || []), ...selectMiddleware('a', this.middlewares) as T.DAOMiddleware<ADAOGenerics<MetadataType, OperationMetadataType>>[]], name: 'a', logger: this.logger }) as unknown as ADAO<MetadataType, OperationMetadataType>) : new ADAO({ entityManager: this, datasource: 'a', metadata: this.metadata, ...this.overrides?.a, collection: db.collection('as'), middlewares: [...(this.overrides?.a?.middlewares || []), ...selectMiddleware('a', this.middlewares) as T.DAOMiddleware<ADAOGenerics<MetadataType, OperationMetadataType>>[]], name: 'a', logger: this.logger })
    }
    return this._a
  }
  get b(): BDAO<MetadataType, OperationMetadataType> {
    if(!this._b) {
      ...
      this._b = db === 'mock' ? (new InMemoryBDAO({ entityManager: this, datasource: null, metadata: this.metadata, ...this.overrides?.b, middlewares: [...(this.overrides?.b?.middlewares || []), ...selectMiddleware('b', this.middlewares) as T.DAOMiddleware<BDAOGenerics<MetadataType, OperationMetadataType>>[]], name: 'b', logger: this.logger }) as unknown as BDAO<MetadataType, OperationMetadataType>) : new BDAO({ entityManager: this, datasource: 'default', metadata: this.metadata, ...this.overrides?.b, collection: db.collection('bs'), middlewares: [...(this.overrides?.b?.middlewares || []), ...selectMiddleware('b', this.middlewares) as T.DAOMiddleware<BDAOGenerics<MetadataType, OperationMetadataType>>[]], name: 'b', logger: this.logger })
    }
    return this._b
  }
  get c(): CDAO<MetadataType, OperationMetadataType> {
    if(!this._c) {
      const db = this.mongodb.default
      this._c = db === 'mock' ? (new InMemoryCDAO({ entityManager: this, datasource: null, metadata: this.metadata, ...this.overrides?.c, middlewares: [...(this.overrides?.c?.middlewares || []), ...selectMiddleware('c', this.middlewares) as T.DAOMiddleware<CDAOGenerics<MetadataType, OperationMetadataType>>[]], name: 'c', logger: this.logger }) as unknown as CDAO<MetadataType, OperationMetadataType>) : new CDAO({ entityManager: this, datasource: 'default', metadata: this.metadata, ...this.overrides?.c, collection: db.collection('cs'), middlewares: [...(this.overrides?.c?.middlewares || []), ...selectMiddleware('c', this.middlewares) as T.DAOMiddleware<CDAOGenerics<MetadataType, OperationMetadataType>>[]], name: 'c', logger: this.logger })
    }
    return this._c
  }
  get d(): DDAO<MetadataType, OperationMetadataType> {
    if(!this._d) {
      ...
      this._d = db === 'mock' ? (new InMemoryDDAO({ entityManager: this, datasource: null, metadata: this.metadata, ...this.overrides?.d, middlewares: [...(this.overrides?.d?.middlewares || []), ...selectMiddleware('d', this.middlewares) as T.DAOMiddleware<DDAOGenerics<MetadataType, OperationMetadataType>>[]], name: 'd', logger: this.logger }) as unknown as DDAO<MetadataType, OperationMetadataType>) : new DDAO({ entityManager: this, datasource: 'default', metadata: this.metadata, ...this.overrides?.d, knex: db, tableName: 'ds', middlewares: [...(this.overrides?.d?.middlewares || []), ...selectMiddleware('d', this.middlewares) as T.DAOMiddleware<DDAOGenerics<MetadataType, OperationMetadataType>>[]], name: 'd', logger: this.logger })
    }
    return this._d
  }
  get e(): EDAO<MetadataType, OperationMetadataType> {
    if(!this._e) {
      const db = this.knex.default
      this._e = db === 'mock' ? (new InMemoryEDAO({ entityManager: this, datasource: null, metadata: this.metadata, ...this.overrides?.e, middlewares: [...(this.overrides?.e?.middlewares || []), ...selectMiddleware('e', this.middlewares) as T.DAOMiddleware<EDAOGenerics<MetadataType, OperationMetadataType>>[]], name: 'e', logger: this.logger }) as unknown as EDAO<MetadataType, OperationMetadataType>) : new EDAO({ entityManager: this, datasource: 'default', metadata: this.metadata, ...this.overrides?.e, knex: db, tableName: 'es', middlewares: [...(this.overrides?.e?.middlewares || []), ...selectMiddleware('e', this.middlewares) as T.DAOMiddleware<EDAOGenerics<MetadataType, OperationMetadataType>>[]], name: 'e', logger: this.logger })
    }
    return this._e
  }
  get f(): FDAO<MetadataType, OperationMetadataType> {
    if(!this._f) {
      const db = this.knex.default
      this._f = db === 'mock' ? (new InMemoryFDAO({ entityManager: this, datasource: null, metadata: this.metadata, ...this.overrides?.f, middlewares: [...(this.overrides?.f?.middlewares || []), ...selectMiddleware('f', this.middlewares) as T.DAOMiddleware<FDAOGenerics<MetadataType, OperationMetadataType>>[]], name: 'f', logger: this.logger }) as unknown as FDAO<MetadataType, OperationMetadataType>) : new FDAO({ entityManager: this, datasource: 'default', metadata: this.metadata, ...this.overrides?.f, knex: db, tableName: 'fs', middlewares: [...(this.overrides?.f?.middlewares || []), ...selectMiddleware('f', this.middlewares) as T.DAOMiddleware<FDAOGenerics<MetadataType, OperationMetadataType>>[]], name: 'f', logger: this.logger })
    }
    return this._f
  }
