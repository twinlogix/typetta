import { Params, SecurityPolicyReadError, SecurityPolicyWriteError } from '../../src'
...
async function createSecureEntityManager(userId: string): Promise<SecureEntityManager> {
  ...
  function createSecurityContext(roles: Params<'UserRole', AST, Scalars, { role: { permissions: true }; hotelId: true; userId: true; tenantId: true }>[]): SecurityContext {
